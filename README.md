# Prompt Vault v3.5.4 — Persistent Google Drive Sync + Mobile Menu
...
- Added a visible v3.5.4 marker in the sidebar footer for deployment verification.
...
## v3.5.4 category deletion sync fix
...
## v3.5.4 Google Drive settings fix
...
## v3.5.4 New Category on Home
- Added a visible **+ New Category** button on phone and computer.
- It opens the existing Manage Category dialog.
- You can create a main category or choose a parent to create a subcategory.
- Preserves custom app icons, Google Drive sync, and the mobile prompt-save/attachment fixes.
