# Prompt Vault v3.5 — Persistent Google Drive Sync + Mobile Menu
...
- Added a visible v3.5 marker in the sidebar footer for deployment verification.
...
## v3.5 category deletion sync fix
