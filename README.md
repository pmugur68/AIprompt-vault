# Prompt Vault v3.5.2 — Persistent Google Drive Sync + Mobile Menu
...
- Added a visible v3.5.2 marker in the sidebar footer for deployment verification.
...
## v3.5.2 category deletion sync fix
...
## v3.5.2 Google Drive settings fix
