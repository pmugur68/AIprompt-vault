# Prompt Vault v3.5.1 — Persistent Google Drive Sync + Mobile Menu
...
- Added a visible v3.5.1 marker in the sidebar footer for deployment verification.
...
## v3.5.1 category deletion sync fix
...
## v3.5.1 Google Drive settings fix
